...
def fit_transformer(model, max_seq_length, batch_size=32, num_epochs=10, learning_rate=1e-3, device='cpu'):
    ...
    src_tensor=[french_tokenizer(text, padding=True, truncation=True, return_tensors="pt", max_length=256)["input_ids"] for text in src_sentences]
    ...
    trg_tensor = [english_tokenizer(text, padding=True, truncation=True, return_tensors="pt", max_length=256)["input_ids"] for text in trg_sentences]
